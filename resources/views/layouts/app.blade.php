...
<head>
    ...
    <!-- Scripts -->
    @vite(['resources/sass/app.scss', 'resources/css/app.css', 'resources/js/app.js', 'resources/css/soft-ui-dashboard.min.css', 'resources/js/soft-ui-dashboard.min.js', 'resources/css/sweetalert2.min.css', 'resources/js/sweetalert2.min.js'])
</head>
                    ...
                    <div class="container-fluid py-1 px-3">
                        ...
                        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                            ...
                            <ul class="navbar-nav  justify-content-end">
                                <li class="nav-item dropdown">
                                    <a id="navbarDropdown" class="nav-link dropdown-toggle" aria-expanded="true"
