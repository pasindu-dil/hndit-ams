...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
            ...
            <span class="ms-1 font-weight-bold">HNDIT AMS</span>
        </a>
    </div>
    <hr class="horizontal dark mt-0">
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            @if ((Auth::user() && Auth::user()->hasRole('Super Admin')) || Auth::user()->hasRole('Admin') || Auth::user()->hasAnyPermission(['dashboard index']))
                <li class="nav-item">
            ...
            @endif
            @if ((Auth::user() && Auth::user()->hasRole('Super Admin')) || Auth::user()->hasRole('Admin') || Auth::user()->hasAnyPermission(['assignment index']))
                <li class="nav-item">
            ...
            @endif
            @if ((Auth::user() && Auth::user()->hasRole('Super Admin')) || Auth::user()->hasRole('Admin') || Auth::user()->hasAnyPermission(['report index']))
                <li class="nav-item">
            ...
            @endif
            @if ((Auth::user() && Auth::user()->hasRole('Super Admin')) || Auth::user()->hasRole('Admin') || Auth::user()->hasRole('Student') || Auth::user()->hasAnyPermission(['student index']))
                <li class="nav-item">
